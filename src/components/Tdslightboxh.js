...
const images = [
    ...
    {
        src: require("./../images/h2.JPG"),
        description: 'description'
    },
    {
        src: require("./../images/h3.jpg"),
        description: 'description'
    },
    {
        src: require("./../images/h4.jpg"),
        description: 'description'
    },
    {
        src: require("./../images/h5.jpg"),
        description: 'description'
    },
    {
        src: require("./../images/h6.jpg"),
        description: 'description'
    }
];

class Tdslightboxh extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            photoIndex: 0,
